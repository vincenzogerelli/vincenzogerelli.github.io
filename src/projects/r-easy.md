...
sommario: A full-stack smart-bin IoT system combining Arduino sensors, Raspberry Pi aggregation, remote server processing, and an iOS app.
immagine: /img/r-easy.png
tech:
  - Python
  - Swift
  - Arduino
...
**Tech stack:** Python, Swift, Arduino, Raspberry Pi, Cisco IOS, IoT.
